...
<script>
  import { quoted_class_new, quoted_class_find, quoted_class_update, quoted_class_delete } from '../../api/api.js'
        ...
        switch (true) {
          ...
          case state === 1:
            this.form = {
              ...
              id: data.id,
              image: data.quoted_class_image,
              text: data.quoted_class_text,
              price: data.quoted_class_price,
              case_class_id: data.quoted_class_class_id
            }
            this.url = process.env.API_SERVER_ADDR + '/public/uploads/' + data.quoted_class_image
